 ...
 */
public class CBParameterMetaData implements ParameterMetaData
{
    final CBPreparedResult preparedResult;

    public  CBParameterMetaData(CBPreparedResult preparedResult)
    {
